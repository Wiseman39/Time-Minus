...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2020 at 11:36 PM
...
(3, '<html><div style=\\\"text-align:center\\\"><b>Step 3:</b><br>Turn right in to the passage way,The academic office will be on your right, then turn left in to the second passage way</div></html>'),
(4, '<html><div style=\\\"text-align:center\\\"><b>Step 4:</b><br>B201 is located at the end of this passage way</div></html>');
...
--
ALTER TABLE `0to1`
  MODIFY `DirectNo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
